<div x-data="{ shownHero: false }" x-intersect.half="shownHero = true" class="bg-charcoal text-white h-[100svh] lg:h-screen relative">
  ...
  <div class="absolute bottom-0 left-0 px-4 md:px-8 lg:px-16 pb-6 md:pb-8 lg:pb-12 lg:w-1/2 lg:max-w-[778px] flex flex-col gap-y-6 lg:gap-y-10">
    <h2 x-show="shownHero" x-transition.opacity.duration.3000ms class="font-serif text-4xl md:text-8xl lg:text-10xl leading-8 md:leading-6 tracking-tight">In <em>everything</em>, we instill trust by upholding the highest stands of ethics in our practice.</h2>
...
<div x-data="{ shownOne: false }" x-intersect.half="shownOne = true" class="flex flex-col lg:flex-row" id="strategic-approach">
  <div class="lg:w-7/12">
  ...
  <div class="lg:w-5/12 p-4 md:p-8 lg:p-16 flex flex-col justify-end gap-y-11 bg-light-gray lg:bg-gradient-to-b from-dark-gray to-charcoal">
    <h3 x-show="shownOne" x-transition.opacity.duration.2000ms class="-mt-[75px] md:-mt-[104px] lg:mt-0 text-9xl md:text-[3.3rem] lg:text-12xl leading-10 lg:leading-4 tracking-wider text-medium-gray font-serif"><em class="text-white block">Strategic</em> Approach</h3>
...
<div x-data="{ shownTwo: false }" x-intersect.half="shownTwo = true" class="flex flex-col lg:flex-row-reverse" id="our-values">
  <div class="lg:w-7/12">
  ...
  <div class="lg:w-5/12 p-4 md:p-8 lg:p-16 flex flex-col justify-end gap-y-11 bg-light-gray lg:bg-gradient-to-b from-dark-gray to-charcoal grow">
    <h3 x-show="shownTwo" x-transition.opacity.duration.2000ms class="-mt-[75px] md:-mt-[104px] lg:mt-0 text-9xl md:text-[3.3rem] lg:text-12xl leading-10 lg:leading-4 tracking-wider text-medium-gray font-serif"><em class="text-white block">Our</em> Values</h3>
