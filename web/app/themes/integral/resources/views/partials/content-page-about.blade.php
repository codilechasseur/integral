<div x-data="{ shownHero: false }" x-intersect.half="shownHero = true" class="bg-charcoal text-white h-[100svh] lg:h-screen relative">
  <img src="@asset('images/hero-about-mobile.jpg')" class="md:hidden h-[100svh] w-screen object-cover" />
  <img src="@asset('images/hero-about-tablet.jpg')" class="hidden md:block lg:hidden h-[100svh] w-screen object-cover" />
  ...
  <div class="absolute bottom-0 left-0 px-4 md:px-8 lg:px-16 pb-6 md:pb-8 lg:pb-12 lg:w-1/2 lg:max-w-[778px] flex flex-col gap-y-6 lg:gap-y-10">
    <h2 x-show="shownHero" x-transition.opacity.duration.3000ms class="font-serif text-4xl md:text-8xl lg:text-10xl leading-8 md:leading-6 tracking-tight">In <em>everything</em>, we instill trust by upholding the highest standards of ethics in our practice.</h2>

    <p x-show="shownHero" x-transition.opacity.duration.3000ms class="text-xs md:text-sm lg:text-base leading-11 font-light">Founded by Andrew Tong, Integral Strategic Real Estate is a boutique real estate investment, management and advisory firm that brings three decades of extensive experience, due diligence and accountability to every engagement. We partner with institutional investors, developers, high net-worth families and not-for-profit organizations to add value to their portfolio, solve real estate challenges and ultimately optimize opportunities.</p>
  </div>
</div>

<div class="flex flex-col lg:flex-row" id="strategic-approach">
  <div class="lg:w-7/12 js-show-on-scroll">
...
<div class="flex flex-col lg:flex-row-reverse" id="our-values">
  <div class="lg:w-7/12 js-show-on-scroll">
...
<section class="bg-[#D3D0D0]">
  <div class="flex flex-col-reverse lg:flex-row p-4 md:p-8 lg:p-[11.36vw] gap-x-[14.6590vw]">
    <div class="flex flex-col justify-end lg:w-1/2">
      ...
      <p class="text-xs lg:text-base leading-11 text-charcoal font-light">Andrew has dedicated his career to the Canadian real estate industry. Over the past thirty years, he has a built a consistent track record of delivering and creating value for stakeholders. His deep and extensive experience includes such roles as Chief Investment Officer of a pension-owned Canadian real estate development and investment firm and seven years as a Managing Director of a Canadian real estate fund valued at $3 billion. Through his leadership and C-suite roles, he has honed a rare set of skills and long-held relationships in the industry. Now with his own practice, Andrew brings his well-earned reputation for pragmatism, directness and results to Integral Strategic Real Estate.</p>
