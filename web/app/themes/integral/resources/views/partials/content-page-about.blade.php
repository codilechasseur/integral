...
<div class="bg-light-gray px-4 md:px-8 lg:px-16 py-16 md:py-20 lg:py-24 grid lg:grid-cols-4 lg:divide-x lg:divide-black gap-y-12 lg:gap-y-32">
  <div class="lg:px-10 first:pt-0 last:pb-0">
    ...
    <p class="text-xs lg:text-base font-light">Client opportunities are unique, so we deliver a highly individualized approach that reflects specific requirements. When faced with challenging situations, we thrive on finding creative ways to overcome complexities.</p>
  </div>
  ...
  <div class="lg:px-10 first:pt-0 last:pb-0">
    ...
    <p class="text-xs lg:text-base font-light">Our phased engagements are designed to build a clear path forward within complex organizations or relationships.</p>
  </div>
  ...
  <div class="lg:px-10 first:pt-0 last:pb-0">
    ...
    <p class="text-xs lg:text-base font-light">We help clients effectively manage volatility and identify potential for their portfolio, so they can build a legacy of value.</p>
  </div>
</div>
