<div x-data="{ shownHero: false }" x-intersect.half="shownHero = true" class="text-white h-screen relative">
  <img x-show="shownHero" x-transition.opacity.duration.750ms src="@asset('images/hero-what-we-do-mobile.jpg')" class="md:hidden h-screen w-screen object-cover" />
  <img x-show="shownHero" x-transition.opacity.duration.750ms src="@asset('images/hero-what-we-do-tablet.jpg')" class="hidden md:block lg:hidden h-screen w-screen object-cover" />
  <img x-show="shownHero" x-transition.opacity.duration.750ms src="@asset('images/hero-what-we-do-desktop.jpg')" class="hidden lg:block h-screen w-screen object-cover" />
  ...
  <div class="absolute bottom-0 left-0 px-4 md:px-8 lg:px-16 pb-6 md:pb-8 lg:pb-12 lg:w-1/2 lg:max-w-[778px] flex flex-col gap-y-6 lg:gap-y-10">
    <h2 x-show="shownHero" x-transition.opacity.duration.3000ms class="font-serif text-4xl md:text-8xl lg:text-10xl leading-8 md:leading-6 tracking-tight">Our work and our approach have been <em>honed over decades</em> of experience in a constantly evolving industry.</h2>

    <p x-show="shownHero" x-transition.opacity.duration.3000ms class="text-xs md:text-sm lg:text-base leading-11 font-light">Integral Strategic Real Estate proudly provides an individualized investment approach to institutional investors and high-net-worth families. Thirty years in the industry has transformed our best practices and developed our phased, pragmatic and trusted process for Investments, Asset & Portfolio Management and Advisory services.</p>
  </div>
</div>
...
<section class="first progress-wrapper bg-light-gray">
  ...
  <div x-data="{ shownOne: false }" x-intersect.half="shownOne = true" class="progress-item flex flex-col-reverse lg:flex-row p-12 md:py-16 md:px-32 lg:py-28 gap-x-[14.6590vw]">
    <div class="flex flex-col justify-end lg:w-1/2">
      <h3 x-show="shownOne" x-transition.opacity.duration.2000ms class="font-serif text-5xl md:text-8xl lg:text-10xl leading-6 tracking-tight mb-6">We view each <em>investment</em> as a fresh <em>opportunity</em> to uncover value.</h3>
    ...
    <div class="lg:w-1/2 mb-12 lg:mb-0">
      <img class="w-full" x-show="shownOne" x-transition.opacity.duration.2000ms src="@asset('images/what-we-do-investments.jpg')" />
    </div>
  </div>
</section>
...
<section class="second progress-wrapper bg-light-gray">
  ...
  <div x-data="{ shownTwo: false }" x-intersect.half="shownTwo = true" class="progress-item flex flex-col-reverse lg:flex-row-reverse p-12 md:py-16 md:px-32 lg:py-28 gap-x-[14.6590vw]">
    ...
    <div class="lg:w-1/2 mb-12 lg:mb-0">
      <img class="w-full" x-show="shownTwo" x-transition.opacity.duration.2000ms src="@asset('images/what-we-do-asset-management.png')" class="rounded-full" />
    </div>
  </div>
</section>
...
<section class="third progress-wrapper bg-light-gray">
  ...
  <div x-data="{ shownThree: false }" x-intersect.half="shownThree = true" class="progress-item flex flex-col-reverse lg:flex-row p-12 md:py-16 md:px-32 lg:py-28 gap-x-[14.6590vw]">
    ...
    <div class="lg:w-1/2 mb-12 lg:mb-0">
      <img class="w-full" x-show="shownThree" x-transition.opacity.duration.2000ms src="@asset('images/what-we-do-advisory.jpg')" />
    </div>
  </div>
</section>
