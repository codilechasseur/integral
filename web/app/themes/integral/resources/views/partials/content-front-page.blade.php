...
<div class="bg-dust flex flex-col lg:flex-row h-screen">
  ...
  {{-- <div class="antialiased w-full bg-gradient-to-b flex flex-col font-sans from-black items-stretch justify-center h-screen to-gray-900 sm:flex-row sm:items-center">
    <div class="flex flex-col flex-grow items-stretch min-w-md w-full h-full sm:flex-row sm:overflow-hidden">
      ...
      <div class="pane active bg-gradient-to-r from-[#6D696A] to-[#858081] cursor-pointer duration-700 ease-in-out overflow-hidden relative transition-all w-[120px]">
        <div class="content flex flex-row justify-center leading-tight text-white max-w-0">
          <div class="copy ease-in-out font-bold duration-700 opacity-0 relative transform transition-all serif text-9xl text-dark-gray">
            Three decades in the business allows me to provide an unfiltered perspective.
          </div>

          <div class="h-full flex justify-between items-center [writing-mode:vertical-lr] uppercase text-3xl text-white py-14 w-[120px]">
            <div><span class="text-2xs">01</span> Investments</div>
            <div class="bg-gray-900 flex items-center justify-center">@svg('images/icon-arrows')</div>
          </div>
        </div>
      ...
      <div class="pane bg-medium-gray cursor-pointer duration-700 ease-in-out overflow-hidden relative transition-all w-[120px]">
        <div class="content flex flex-row justify-center leading-tight text-white max-w-0">
          <div class="ease-in-out font-bold duration-700 opacity-0 relative transform transition-all serif text-9xl text-dark-gray">
            Realize your vision
          </div>
        </div>
      ...
      <div class="pane bg-dust cursor-pointer duration-700 ease-in-out overflow-hidden relative transition-all w-[120px]">
        <div class="content flex flex-row justify-center leading-tight text-white max-w-0">
          <div class="copy ease-in-out font-bold duration-700 opacity-0 relative transform transition-all serif text-9xl text-dark-gray">
            Discover the world
          </div>
