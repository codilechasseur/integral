...
<div class="bg-dust flex flex-col lg:flex-row h-[80vh]">
  <div class="flex flex-col justify-end lg:bg-gradient-to-br from-dark-gray to-charcoal lg:w-2/5 px-4 md:px-8 lg:p-16 gap-y-12 min-w-[650px]">
